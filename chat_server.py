        ...
        try:
            ...
            if len(msg) > 0:
                ...
                if msg["action"] == "login":
                    ...
                    allow_login = False
                    fail_reason = ""
                    if name not in self.password:
                        allow_login = True
                        self.password[name] = password
                    elif self.password[name]==password:
                        allow_login = True
                    else:
                        allow_login = False
                    ...
                    if allow_login:
                        ...
                        mysend(sock, json.dumps({"action": "login", "status": fail_reason}))
                        print(name + ' failed login: wrong password')
                else:
